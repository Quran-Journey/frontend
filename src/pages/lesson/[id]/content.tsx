        ...
        <Grid container direction="row">
          <Grid item lg={9} sx={{ pr: 9, pb: 10 }}>
            <Grid container direction="column">
              ...
              <Grid item>
                <DetailedSurahTitle
                  name={curr_lesson.name}
                  name_ar={curr_lesson.name_ar}
                  verses={curr_lesson.verses}
                  num={curr_lesson.id}
                />
              </Grid>
              ...
              {ayah_data.map((curr_verse_data) => (
                <VerseCollapse
                  ...
                  translation={curr_verse_data.translation}
                  ayah={curr_verse_data.ayah}
                  word={curr_verse_data.root_words[0].word}
                  root={curr_verse_data.root_words[0].root}
                  blurb={curr_verse_data.root_words[0].blurb}
                  tafsir={curr_verse_data.tafsir[0].text}
                  reflections={curr_verse_data.reflections[0].text}
                />
              ))}
