...
const VerseCollapse = (props) => {
  ...
  return (
    <ListItemButton
      onClick={handleClick}
      sx={{ borderRadius: '22px', width: '100%', m: 0, p: 0, mb: 2 }}
    >
      <Grid
        item
        sx={{
      ...
      >
        <Grid container direction="column">
          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Grid item sx={{ borderBottom: 1, mt: 3 }}></Grid>
            ...
            <Grid item sx={{ mt: 5, mb: 2 }}>
              <Grid container direction="row" alignItems="center">
                <Grid item sx={{ mr: 3 }}>
                  <Typography variant="h5">Tafasir</Typography>
                </Grid>
                <Grid item>
                  <Button
                    variant="outlined"
                    color="dark"
                    endIcon={<ArrowDropDownCircleRoundedIcon />}
                  >
                    {' '}
                    {verse_data[0].tafsir[0].mufasir}{' '}
                  </Button>
                </Grid>
              </Grid>
            </Grid>
