export const surahLesson = [
    {
        ...
        tafsir: [
            ...
            {
                mufasir: 'Abd Allāh ibn ʿUmar ibn Muḥammad al-Bayḍāwī , Anwār al-tanzīl wa asrār al-taʾwīl (d. 685H)',
        ...
        root_words: [
            {
                ...
                root: 'وري',
                blurb: 'The فَ in the word فَالْمُورِيَاتِ is as the faa of conjunction الفاء عاطفة and serves also make thus ayah an oath by way of connecting to the وَ of oath in the first ayah. \n The word فَالْمُورِيَاتِ is from the root وري and is associated with the meanings of: to kindle, fire, to strike fire \n Here is is in the form of a verbal noun such that it is referring to the thing that produces fire/strikes fire makes sparks i.e hoof',
            },
            {
                word: 'قَدْحًا',
                root: 'قدح',
                blurb: 'The word قَدْحًا is from the root قدح and is associated with the meanings of: to bore, to pierce; flint, fire iron (for striking sparks from flint)',
            }
        ],
        tafsir: [
            {
