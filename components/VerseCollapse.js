...
import VerseIntro from './VerseIntro';
...
const VerseCollapse = (props) => {
    ...
    return (
        <ListItemButton onClick={handleClick} sx={{ borderRadius: '22px', width: '100%', m: 0, p: 0, mb: 2 }}>

            <Grid item sx={{ backgroundColor: '#EEF1EC', py: 3, px: 4, borderRadius: '22px', width: '100%' }}>

                <Grid container direction='column'>

                    {/* Ayah header section */}
                    <VerseIntro name_ar={props.name_ar} surah_num={props.surah_num} verse_num={props.verse_num} translation={props.translation} ayah={props.ayah} />
                    {/* <Grid item sx={{ mb: 1 }}>
                    ...
                    <Collapse in={open} timeout="auto" unmountOnExit>
                        ...
                        <Grid item sx={{ mb: 3, borderBottom: 1, pb: 5 }}>
